                                ...
                                <div class="col-6">
                                    <div class="d-flex align-items-center">
                                        <svg class="bi text-primary" width="32" height="32" fill="blue"
                                            style="width:10px">
                                            <use
                                                xlink:href="<?= base_url; ?>/assets/images/bootstrap-icons.svg#circle-fill" />
                                        </svg>
                ...
                <div class="card-body py-6 px-6">
                    <div class="d-flex align-items-center">
                        <div class="avatar avatar-xl">
                            <img src="<?= base_url; ?>/assets/images/faces/download.jpeg" alt="Face 1">
                        </div>
                        <div class="ms-3 name">
                            <h5 class="font-bold">Gojo Satoru</h5>
                            <h6 class="text-muted mb-0">@Gojosatoru</h6>
                        </div>
                    </div>
                </div>
            </div>
